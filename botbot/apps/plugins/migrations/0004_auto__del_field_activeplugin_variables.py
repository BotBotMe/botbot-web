...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivePlugin.variables'
        db.delete_column(u'plugins_activeplugin', 'variables')


    def backwards(self, orm):
        # Adding field 'ActivePlugin.variables'
        db.add_column(u'plugins_activeplugin', 'variables',
                      self.gf(u'django_hstore.fields.DictionaryField')(null=True, blank=True),
                      keep_default=False)
