...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Channel.private_slug'
        db.alter_column(u'bots_channel', 'private_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True))


    def backwards(self, orm):

        # Changing field 'Channel.private_slug'
        db.alter_column(u'bots_channel', 'private_slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, unique=True))
