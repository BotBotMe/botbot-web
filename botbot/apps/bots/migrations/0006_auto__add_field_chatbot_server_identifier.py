...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatBot.server_identifier'
        db.add_column(u'bots_chatbot', 'server_identifier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=164),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChatBot.server_identifier'
        db.delete_column(u'bots_chatbot', 'server_identifier')
