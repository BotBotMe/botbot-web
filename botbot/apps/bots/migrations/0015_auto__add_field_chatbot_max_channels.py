...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatBot.max_channels'
        db.add_column(u'bots_chatbot', 'max_channels',
                      self.gf('django.db.models.fields.IntegerField')(default=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChatBot.max_channels'
        db.delete_column(u'bots_chatbot', 'max_channels')
