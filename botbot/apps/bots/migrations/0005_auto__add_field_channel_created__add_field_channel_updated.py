...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bots_channel', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 30, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Channel.updated'
        db.add_column(u'bots_channel', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.created'
        db.delete_column(u'bots_channel', 'created')

        # Deleting field 'Channel.updated'
        db.delete_column(u'bots_channel', 'updated')
