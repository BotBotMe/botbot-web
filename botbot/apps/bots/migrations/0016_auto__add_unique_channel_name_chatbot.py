...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Channel', fields ['name', 'chatbot']
        db.create_unique(u'bots_channel', ['name', 'chatbot_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Channel', fields ['name', 'chatbot']
        db.delete_unique(u'bots_channel', ['name', 'chatbot_id'])
