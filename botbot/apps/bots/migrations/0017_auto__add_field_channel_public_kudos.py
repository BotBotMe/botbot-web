...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.public_kudos'
        db.add_column(u'bots_channel', 'public_kudos',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.public_kudos'
        db.delete_column(u'bots_channel', 'public_kudos')
