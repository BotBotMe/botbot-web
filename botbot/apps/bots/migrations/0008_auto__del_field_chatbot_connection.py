...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChatBot.connection'
        db.delete_column(u'bots_chatbot', 'connection')


    def backwards(self, orm):
        # Adding field 'ChatBot.connection'
        db.add_column(u'bots_chatbot', 'connection',
                      self.gf(u'django_hstore.fields.DictionaryField')(default={'is': 'not used'}),
                      keep_default=False)
    ...
    models = {
        ...
        u'plugins.activeplugin': {
            ...
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bots.Channel']"}),
            'configuration': ('botbot.core.fields.JSONField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
