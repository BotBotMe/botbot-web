...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'logs_log', (
            ...
            ('bot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bots.ChatBot'], null=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bots.Channel'], null=True)),
            ...
            ('command', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
    ...
    models = {
        ...
        u'logs.log': {
            ...
            'bot': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bots.ChatBot']", 'null': 'True'}),
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bots.Channel']", 'null': 'True'}),
            'command': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
