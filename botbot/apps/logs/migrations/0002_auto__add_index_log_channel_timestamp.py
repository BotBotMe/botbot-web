...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Log', fields ['channel', 'timestamp']
        db.create_index(u'logs_log', ['channel_id', 'timestamp'])


    def backwards(self, orm):
        # Removing index on 'Log', fields ['channel', 'timestamp']
        db.delete_index(u'logs_log', ['channel_id', 'timestamp'])
    ...
    models = {
        ...
        u'logs.log': {
            'Meta': {'ordering': "('-timestamp',)", 'object_name': 'Log', 'index_together': "[['channel', 'timestamp']]"},
