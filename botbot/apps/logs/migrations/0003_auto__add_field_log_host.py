...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.host'
        db.add_column(u'logs_log', 'host',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Log.host'
        db.delete_column(u'logs_log', 'host')
    ...
    models = {
        ...
        u'logs.log': {
            ...
            'host': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
