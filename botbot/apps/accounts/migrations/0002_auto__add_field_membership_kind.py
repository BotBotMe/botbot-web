...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.kind'
        db.add_column(u'accounts_membership', 'kind',
                      self.gf('django.db.models.fields.CharField')(default='personal', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.kind'
        db.delete_column(u'accounts_membership', 'kind')
